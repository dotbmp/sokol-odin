...
when ODIN_OS == .Windows {
    when USE_DLL {
        when USE_VULKAN {
            when DEBUG { foreign import sokol_log_clib { "../sokol_dll_windows_x64_vulkan_debug.lib" } }
            else       { foreign import sokol_log_clib { "../sokol_dll_windows_x64_vulkan_release.lib" } }
        } else when USE_GL {
        ...
        when USE_VULKAN {
            when DEBUG { foreign import sokol_log_clib { "sokol_log_windows_x64_vulkan_debug.lib" } }
            else       { foreign import sokol_log_clib { "sokol_log_windows_x64_vulkan_release.lib" } }
        } else when USE_GL {
