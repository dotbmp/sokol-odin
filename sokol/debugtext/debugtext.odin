...
when ODIN_OS == .Windows {
    when USE_DLL {
        when USE_VULKAN {
            when DEBUG { foreign import sokol_debugtext_clib { "../sokol_dll_windows_x64_vulkan_debug.lib" } }
            else       { foreign import sokol_debugtext_clib { "../sokol_dll_windows_x64_vulkan_release.lib" } }
        } else when USE_GL {
        ...
        when USE_VULKAN {
            when DEBUG { foreign import sokol_debugtext_clib { "sokol_debugtext_windows_x64_vulkan_debug.lib" } }
            else       { foreign import sokol_debugtext_clib { "sokol_debugtext_windows_x64_vulkan_release.lib" } }
        } else when USE_GL {
    ...
    when USE_VULKAN {
        when USE_DLL {
            when DEBUG { foreign import sokol_debugtext_clib { "sokol_debugtext_linux_x64_vulkan_debug.so" } }
            else       { foreign import sokol_debugtext_clib { "sokol_debugtext_linux_x64_vulkan_release.so" } }
        } else {
            when DEBUG { foreign import sokol_debugtext_clib { "sokol_debugtext_linux_x64_vulkan_debug.a" } }
            else       { foreign import sokol_debugtext_clib { "sokol_debugtext_linux_x64_vulkan_release.a" } }
        }
    } else {
        when USE_DLL {
