...
when ODIN_OS == .Windows {
    when USE_DLL {
        when USE_VULKAN {
            when DEBUG { foreign import sokol_audio_clib { "../sokol_dll_windows_x64_vulkan_debug.lib" } }
            else       { foreign import sokol_audio_clib { "../sokol_dll_windows_x64_vulkan_release.lib" } }
        } else when USE_GL {
        ...
        when USE_VULKAN {
            when DEBUG { foreign import sokol_audio_clib { "sokol_audio_windows_x64_vulkan_debug.lib" } }
            else       { foreign import sokol_audio_clib { "sokol_audio_windows_x64_vulkan_release.lib" } }
        } else when USE_GL {
